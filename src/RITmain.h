...
// [[Rcpp::plugins(cpp11)]]
// [[Rcpp::plugins(openmp)]]
set<vector<int> > RIT_basic(RaggedArray &x, const int L, const double branch, const int depth,
    const int n_trees, unsigned const int min_inter_sz, const int n_cores, const int n) {
