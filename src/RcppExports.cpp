...
RcppExport SEXP FSInteract_RIT_1class(SEXP zSEXP, SEXP LSEXP, SEXP branchSEXP, SEXP depthSEXP, SEXP n_treesSEXP, SEXP min_inter_szSEXP, SEXP n_coresSEXP, SEXP is_sparseSEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(RIT_1class(z, L, branch, depth, n_trees, min_inter_sz, n_cores, is_sparse));
    return __result;
END_RCPP
}
// RIT_2class
...
RcppExport SEXP FSInteract_RIT_2class(SEXP zSEXP, SEXP z0SEXP, SEXP LSEXP, SEXP branchSEXP, SEXP depthSEXP, SEXP n_treesSEXP, SEXP theta0SEXP, SEXP theta1SEXP, SEXP min_inter_szSEXP, SEXP n_coresSEXP, SEXP is_sparseSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< SEXP >::type z(zSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type n_cores(n_coresSEXP);
    Rcpp::traits::input_parameter< bool >::type is_sparse(is_sparseSEXP);
    __result = Rcpp::wrap(RIT_2class(z, z0, L, branch, depth, n_trees, theta0, theta1, min_inter_sz, n_cores, is_sparse));
    return __result;
END_RCPP
}
