...
RcppExport SEXP _FSInteractX_RIT_1class(SEXP zSEXP, SEXP LSEXP, SEXP branchSEXP, SEXP depthSEXP, SEXP n_treesSEXP, SEXP min_inter_szSEXP, SEXP n_coresSEXP, SEXP is_sparseSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(RIT_1class(z, L, branch, depth, n_trees, min_inter_sz, n_cores, is_sparse));
...
RcppExport SEXP _FSInteractX_RIT_2class(SEXP zSEXP, SEXP z0SEXP, SEXP LSEXP, SEXP branchSEXP, SEXP depthSEXP, SEXP n_treesSEXP, SEXP theta0SEXP, SEXP theta1SEXP, SEXP min_inter_szSEXP, SEXP n_coresSEXP, SEXP is_sparseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type z(zSEXP);
...
SEXP PrevEstimate_internal(SEXP interactions, SEXP z, int L, bool is_sparse, int n_cores);
RcppExport SEXP _FSInteractX_PrevEstimate_internal(SEXP interactionsSEXP, SEXP zSEXP, SEXP LSEXP, SEXP is_sparseSEXP, SEXP n_coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< bool >::type is_sparse(is_sparseSEXP);
    Rcpp::traits::input_parameter< int >::type n_cores(n_coresSEXP);
    rcpp_result_gen = Rcpp::wrap(PrevEstimate_internal(interactions, z, L, is_sparse, n_cores));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_FSInteractX_PrevEstimate_internal", (DL_FUNC) &_FSInteractX_PrevEstimate_internal, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_FSInteractX(DllInfo *dll) {
