...
RIT_1class <- function(z, L, branch, depth, n_trees, min_inter_sz, n_cores, is_sparse) {
    .Call(`_FSInteractX_RIT_1class`, z, L, branch, depth, n_trees, min_inter_sz, n_cores, is_sparse)
}
...
PrevEstimate_internal <- function(interactions, z, L, is_sparse, n_cores) {
    .Call(`_FSInteractX_PrevEstimate_internal`, interactions, z, L, is_sparse, n_cores)
}
